...
--
insert into UserStock (userStockId, userId, stockId, createDate, createdBy, lastChangeDate, lastChangedBy) values (1, 1, 1, sysdate, 'system_user', sysdate, 'system_user');
--
